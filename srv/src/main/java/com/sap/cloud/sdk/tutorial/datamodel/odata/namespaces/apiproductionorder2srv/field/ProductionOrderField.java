...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.apiproductionorder2srv.ProductionOrder ProductionOrder}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ProductionOrderField<FieldT >
    extends EntityField<ProductionOrder, FieldT>
    implements ProductionOrderSelectable
{
     ...
     */
    public ProductionOrderField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ProductionOrderField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
