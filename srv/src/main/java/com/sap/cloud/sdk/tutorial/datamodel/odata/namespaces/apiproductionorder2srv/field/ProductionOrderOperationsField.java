...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.apiproductionorder2srv.ProductionOrderOperations ProductionOrderOperations}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ProductionOrderOperationsField<FieldT >
    extends EntityField<ProductionOrderOperations, FieldT>
    implements ProductionOrderOperationsSelectable
{
     ...
     */
    public ProductionOrderOperationsField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ProductionOrderOperationsField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
