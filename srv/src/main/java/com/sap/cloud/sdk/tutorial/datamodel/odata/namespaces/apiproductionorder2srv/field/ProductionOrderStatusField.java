...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.apiproductionorder2srv.ProductionOrderStatus ProductionOrderStatus}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ProductionOrderStatusField<FieldT >
    extends EntityField<ProductionOrderStatus, FieldT>
    implements ProductionOrderStatusSelectable
{
     ...
     */
    public ProductionOrderStatusField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ProductionOrderStatusField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
