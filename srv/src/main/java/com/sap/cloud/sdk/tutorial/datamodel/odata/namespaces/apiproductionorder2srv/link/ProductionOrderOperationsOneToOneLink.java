...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.apiproductionorder2srv.ProductionOrderOperations ProductionOrderOperations} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.tutorial.datamodel.odata.namespaces.apiproductionorder2srv.link.ProductionOrderOperationsLink ProductionOrderOperationsLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class ProductionOrderOperationsOneToOneLink<ObjectT extends VdmObject<?> >
    extends ProductionOrderOperationsLink<ObjectT>
    implements OneToOneLink<ProductionOrderOperations, ObjectT>
{
     ...
     */
    public ProductionOrderOperationsOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<ProductionOrderOperations> filter(
        @Nonnull
